...
create table ROAMY.trip (
    ...
    default_price_per_adult double,
    tac double,
...
create table ROAMY.target_city (
    id bigint generated by default as identity,
    city_id bigint,
    trip_id bigint,
...
alter table ROAMY.target_city add constraint FK_target_city_city_id foreign key (city_id) references ROAMY.city;
alter table ROAMY.target_city add constraint FK_target_city_trip_id foreign key (trip_id) references ROAMY.trip;
