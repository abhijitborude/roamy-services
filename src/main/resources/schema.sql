...
drop table wallet_transaction if exists;
...
alter table wallet_transaction add constraint FK_wallet_transaction_user_id foreign key (user_id) references user;
